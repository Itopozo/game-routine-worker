/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c5b006de0fdc7f91b151102cb26bbea4)
// Runtime types generated with workerd@1.20260708.1 2026-07-14 nodejs_compat
interface __BaseEnv_Env {
	NOTIFICATION_STATE: KVNamespace;
	DISCORD_WEBHOOK_URL: string;
	HOYOLAB_LTUID_V2: string;
	HOYOLAB_LTOKEN_V2: string;
	HOYOLAB_COOKIE_TOKEN_V2: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_WEBHOOK_URL" | "HOYOLAB_LTUID_V2" | "HOYOLAB_LTOKEN_V2" | "HOYOLAB_COOKIE_TOKEN_V2">> {}
}
